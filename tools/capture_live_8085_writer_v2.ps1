...
$Out = Join-Path $PSScriptRoot 'CAPTURED_LIVE_8085_WRITER_V2'
...
Add-Report 'CAPTURE TOOL V2 - PowerShell 5.1 compatible'
...
# First priority: explicit .py paths from the live :8085 process command line.
...
# Sort by path first, then by score descending. Avoids the parser issue in capture v1.
...
Add-Report ''
Add-Report 'CAPTURE OK. Attach LIVE_8085_WRITER.py to ChatGPT.'
exit 0
